...
{
    // default connection
    public static $dbname = 'menu_card'; // Your database name
    ...
    public static $upload_folder_def = '../../assets/uploads'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
    ...
    // xcrud folder url
    public static $scripts_url = 'http://127.0.0.1:8080/ham/'; // URL to the xCRUD folder, not real path, without a trailing slash, can be relative, e.g. 'some_folder/xcrud' or absolute, e.g. 'http://www.your_site.com/some_folder/xcrud'. If empty - will be detected automatically
    ...
    public static $autoclean_timeout = 50; // in seconds. Do not change, if not sure. Xcrud clears old instances in session when you reload browser tab or open new tab with xcrud. In this case Xcrud can't work in two tabs in the same time. You can increase timeout on your risk.
