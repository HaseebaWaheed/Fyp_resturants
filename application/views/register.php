		...
		<div class="header-left-bottom">
            ...
            <form method="post" action="<?=base_url("register/validation")?>"">
                    ...
                    <div class="icon1 form-group">
                        ...
                        <input class="form-control" type="email" name='email'placeholder="Email Address" value="<?php echo set_value('email');?>" required=""/>
                    ...
                    <div class="icon1 form-group">
                        ...
                        <input class="form-control" type="password" name='password' placeholder="Password" value="<?php echo set_value('password');?>" required=""/>
