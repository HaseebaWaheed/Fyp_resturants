...
<div class="w3layouts-main"> 
	<div class="bg-layer">
		...
		<div class="header-main">
            ...
            <form method="post" action="<?=base_url("home/check_login")?>"">
					...
					<div class="links">
						<p><a href="<?php echo base_url();?>email">Forgot Password?</a></p>
						<p class="right"><a href="<?php echo base_url();?>register">New User? Register</a></p>
						<div class="clear"></div>
					</div>
				</form>	
			</div>
